...
// slist-int-eval.c
//========================================================================
// This program evalutes the performance of SListSpoly::push_front and
// SListSpoly::reverse by running multiple trials and averaging the
// elapsed run times.
//
...
void print_help()
{
  printf(
    ...
    "Evaluation program for SListSpoly::push_front and SListSpoly::reverse\n\n"
