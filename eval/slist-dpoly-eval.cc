...
// slist-dpoly-eval.c
//========================================================================
// This program evalutes the performance of SListDpoly::push_front and
// SListDpoly::reverse by running multiple trials and averaging the
// elapsed run times.
//
...
{
  printf(
    "usage: ./slist-iobj-eval <size>\n\n"
    "Evaluation program for SListDpoly::push_front and SListDpoly::reverse\n\n"
